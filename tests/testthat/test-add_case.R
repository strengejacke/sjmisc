...
test_that("add_case", {
  ...
  expect_is(add_case(d, b = "d", .after = -1)[1, 1], NA)
  expect_is(add_case(d, b = "d", a = 5, .before = 1)[1, 1], 5)
  expect_is(add_case(d, b = "d", a = 5, .after = Inf)[4, 1], 5)
  expect_is(add_case(d, b = "d", .after = 2)[4, 1], NA)
  expect_is(add_case(d, b = "d", .after = 5)[4, 1], NA)
  expect_is(add_case(d, b = "d", a = 5, .after = 2, .before = 2)[2, 1], 5)
})
...
test_that("add_variable", {
  ...
  expect_equal(colnames(add_variables(d, new = c(4, 4, 4), new2 = c(5, 5, 5), .after = "b")[2:3], c("new", "new2")))
